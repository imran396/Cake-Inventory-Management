...
<div class="purchases index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Products'), array('controller'=>'purchasedetails', $purchase['Purchase']['id'])); ?>  |
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $purchase['Purchase']['id'])); ?>  |
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $purchase['Purchase']['id']), null, __('Are you sure you want to delete # %s?', $purchase['Purchase']['id'])); ?>
